	...
	function menu($direccion,$nivel,$soloReportes) 
	{
		if($direccion == "DG"  || $direccion == "A" || $direccion == "B" || $direccion == "C" || $direccion == "D" )
		{
			...
			$menu = '
				...
				if($soloReportes != 1 )$menu .= '<li><a class="menu_pfrr redonda3" href="?cont=frListaPlazo"> <img src="images/pliego_pfrr.png" /> <span> Ver Plazo </span></a></li>';
				...
				if($soloReportes != 1 )$menu .= '<li><a class="menu_pfrr redonda3" href="?cont=resolucionesLista"> <img src="images/pliego_pfrr.png" /> <span> Ver Resoluciones Notificadas </span></a></li>';
				...
				if($soloReportes != 1 )$menu .= '<li><a class="menu_pfrr redonda3" href="?cont=controlPFRR"> <img src="images/pliego_pfrr.png" /> <span> Indicadores PFRR </span></a></li>';
				if($soloReportes != 1 )$menu .= '<li><a class="menu_pfrr redonda3" href="?cont=controlEntidad"> <img src="images/pliego_pfrr.png" /> <span> Información por Entidad </span></a></li>';
							...
							<!--[if lte IE 6]><table><tr><td><![endif]-->
								...
								if($soloReportes != 1 )$menu .= '<li><a class="menu_md redonda3" href="#"> <img src="images/medio_actores_small.png" /> <span> Recurso de Reconsideración </span> </a>
									...
									if($soloReportes != 1 )$menu .= '<li><a class="menu_md redonda3" href="#"> <img src="images/medio_nulidad_small.png" /> <span> Juicio de Nulidad </span> </a>
																		<ul class="submenu2 redonda5">
																		    <li> <a class="menu_md redonda3" href="?cont=juicios_v2"> <img src="images/actor.png" /> Ver Actores </a> </li>
																		    <li> <a class="menu_md redonda3" href="?cont=juicios_inserta_v2"> <img src="images/registro_nuevo.png" /> Nuevo Juicio </a> </li>
																			...
																			<li> <a class="menu_md redonda3" href="?cont=juicios_v3"> <img src="images/actor.png" /> Ver Actores </a> </li>
																			<li> <a class="menu_md redonda3" href="?cont=juicios"> <img src="images/actor.png" /> Ver Actores </a> </li>
																		</ul>
																	</li> '; 
										$menu .= '	<li> <a class="menu_md redonda3" href="?cont=juiciosActores"> <img src="images/actor.png" /> Lista Juicios </a> </li>
										<li> <a class="menu_md redonda3" href="?cont=juiciosRRFlista"> <img src="images/book_red.png" /> Lista RRF </a> </li>
										<li> <a class="menu_md redonda3" href="?cont=juicioADlista"> <img src="images/book_red.png" /> Lista AD </a> </li>
										<li> <a class="menu_md redonda3" href="?cont=juiciosOficiosLista"> <img src="images/book_red.png" /> Lista Oficios </a> </li>
													<li> <a class="menu_md redonda3" href="?cont=juiciosSeguimiento"> <img src="images/book_red.png" /> Seguimiento Juicios </a> </li>
													<li> <a class="menu_md redonda3" href="?cont=juiciosVolantesLista"> <img src="images/book_red.png" /> Lista Volantes </a> </li>
													<li> <a class="menu_md redonda3" href="?cont=amparosInLista"> <img src="images/book_red.png" /> Amparos Indirectos </a> </li>
										...
										';
									if(  $_SESSION['usuario'] == "fllamas"){

									}								
									if($direccion == "DG" )
									{
									if($soloReportes != 1 )$menu .= '<li><a class="menu_md redonda3" href="#"> <img src="images/medio_nulidad_small.png" /> <span> Juicios en desarrollo </span> </a>
																		<ul class="submenu2 redonda5">
																		<li> <a class="menu_md redonda3" href="?cont=juiciosActores"> <img src="images/actor.png" /> Lista Juicios </a> </li>
																		
																		   <li> <a class="menu_md redonda3" href="?cont=juiciosAlta"> <img src="images/registro_nuevo.png" /> Nuevo Juicio </a> </li>
																			<li> <a class="menu_md redonda3" href="?cont=juiciosOficiosLista"> <img src="images/book_red.png" /> Lista Oficios </a> </li>
																			<li> <a class="menu_md redonda3" href="?cont=juiciosVolantesLista"> <img src="images/book_red.png" /> Lista Volantes </a> </li>
																		</ul>
																	</li> ';
				...
				if($direccion == "DG" || $direccion == "A" || $direccion == "B" || $direccion == "C" || $direccion == "D")
				{
					...
					<ul class="select menu" id="mInicio">
						<li><a href="#nogo" class="munuSup"><b>Legal Opinions</b><!--[if IE 7]><!--></a><!--<![endif]-->
							<ul class="sub submenu redonda5 ulOpi">';
									if($soloReportes != 1 )$menu .= '<li><a class="menu_opi redonda3" href="?cont=opiniones_escritorio"> <img src="images/file_legal.png" /> <span> Ver Opiniones </span> </a></li>';
				...
				<ul class="select menu" id="mInicio">
					...
					<!--[if lte IE 6]><table><tr><td><![endif]-->
						<ul class="sub submenu redonda5 ulRep">';
							...
							{
								$menu .= '<li><a class="menu_rep redonda3" href="'.damedominio().'/dgr/desarrollo/indexdirx.php"> <img src="images/desktop.png" /> <span>Control DG</span> </a> </li>';
					...
					<ul class="select menu" id="mInicio">
						...
						<!--[if lte IE 6]><table><tr><td><![endif]-->
							<ul class="sub submenu redonda5 ulVol">';
								...
								if($soloReportes != 1)$menu .= '<li><a class="menu_vol redonda3" href="?cont=vol_volantes_medios_otros"> <img src="images/doc_red.png" /> <span>Volantes MD</span> </a>
																	<!-- ul class="submenu2 redonda5">
...
function dameTotalPFRR($accion, $solonom)
{
	...
	while($rp = mysql_fetch_array($sql))
		$totalDevuelto += ( $rp['resarcido'] + $rp['monto_aclarado'] );
...
function dameMontoInicialPFRR($accion)
{
	...
	else $montoInicioPFRR = dameTotalPO($accion);
...
function generaOficios($tipo = "",$fechaOficio, $horaOficio, $acciones, $presunto, $oficioRef, $remitente, $cargo, $dependencia, $asunto, $userForm, $dirForm, $tipoOficio)
{
	...
	//if( $anioAnt = '0000' ) { $anioAnt = $aniocompuesto - 1; } //-------------------MODIFICAR AÑO A PRINCIPIOS DEL 2018 "MUUUY IMPORTANTE"
