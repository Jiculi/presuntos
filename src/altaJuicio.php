...
<body>
    <div class="grid-container">
        ...
        <div class="formita">
            ...
            <button  type="botton" class="boton" name="inserta_juicio" id="inserta_juicio" >Insertar nuevo Juicio</button>
    ...
    <script  src="../presuntos/dist/juicios.js"></script>
    <!-- <script type="text/javascript" src="src/modulos.js"></script>  -->
