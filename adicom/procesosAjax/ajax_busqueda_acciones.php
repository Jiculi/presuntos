...
//------------------------------------------------------------------------------
$sqltxt = "SELECT num_accion,entidad_fiscalizada,cp,subdirector,abogado,direccion,abogado,detalle_de_estado_de_tramite, prescripcion,subnivel FROM po";
		...
		$tabla .= '
				<tr '.$estilo.'  >
					...
					<td class="acciones" align="center">
						...
						<a href="#" title="Control Interno" class="icon-5 info-tooltip" onclick=\'var cuadro1 = new mostrarCuadro(600,900," '.$r['num_accion'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$r['entidad_fiscalizada'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.dameEstado($r['detalle_de_estado_de_tramite']).'",20,"cont/po_informacion.php","numAccion='.$r['num_accion'].'&usuario='.$_SESSION['usuario'].'&direccion='.$_SESSION['direccion'].'&nivel='.$_SESSION['nivel'].'")\'></a>
						';
