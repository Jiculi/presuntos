			...
			';
				while($r = mysql_fetch_array($sql))
				{
					...
					$tabla .= '	<!-- <td class="ancho100">'.$txtStatus.'</td> -->
								...
								<td class="ancho100">
									<a href="#" title="Ver Información" class="icon-5 info-tooltip" onclick=\' new mostrarCuadro(450,800,"Volante de Correpondencia",70,
										"cont/vol_volante.html.php","folio='.$r['folio'].'&direccion='.$_SESSION['direccion'].'") \'></a>';
