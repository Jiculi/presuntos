		...
		*/
		...
		$tabla .= '
				<tr '.$estilo.' >
					...
					<td class="ofiOfi">
						'.$linkSubirArchivo.'
						<a href="#" title="Ver Informacion" onclick=\'new mostrarCuadro(500,700,"Información del Oficio",70,
						"cont/pfrr_oficio_notifica.php","id='.$r['id'].'&abogado='.$r['abogado_solicitante'].'&folio='.$folioOK.'")\' >  
						<img src="images/Document-icon.png"> </a>
					</td>
				</tr>';
	}
		$tabla .= '
