...
//------------------------------------------------------------------------------
		...
		$tabla .= '
				<tr '.$estilo.'  >
					...
					<td class="ancho100" align="right">'. $monto .'</td>
					<td class="ancho50" align="center">'.$r['responsabilidad'].'</td> 
					<td class="ancho100">';
						$tabla .= '<a href="#" title="Ver Información" class="icon-5 info-tooltip" onclick=\'var cuadro2 = new mostrarCuadro(500,900," '.$r['num_accion'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$r['entidad'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.dameEstadoi($conecta,$r['estado']).'",50,"cont/medios_informacion.php","id='.$r['id'].'&usuario='.$_SESSION['usuario'].'&direccion='.$_SESSION['direccion'].'")\'></a>';
						$tabla .= "<a href=\"#\" class=\"icon-1 info-tooltip menuMedios\" onclick=\"var cuadro5 = new mostrarCuadro(400,700,'".$r['nombre']."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$r['num_accion']."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".dameEstadoi($conecta,$r['estado'])."',50,'cont/medios_reconsideracion.php','idPresuntop=".$r['id']."&numAccion=".$r['num_accion']."&usuario=".$_SESSION['usuario']."&direccion=".$_SESSION['direccion']."')\">  </a>";
						//$tabla .= '<a href="#" title="Informacion" class="icon-5 info-tooltip" onclick=\'var cuadro5 = new mostrarCuadro(520,800,"'.$r['nombre'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$r['num_accion'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.dameEstadoi($conecta,$r['estado']).'",50,"cont/pfrr_presuntos_datos.php","idPresuntop='.$r['cont'].'&numAccion='.$r['num_accion'].'&usuario='.$_REQUEST['usuario'].'&direccion='.$_REQUEST['direccion'].'")\'></a>';
						//$tabla .= '<a href="#" title="Montos" class="icon-11 info-tooltip" onclick=\'var cuadro5 = new mostrarCuadro(540,800,"'.$r['nombre'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$r['num_accion'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.dameEstadoi($conecta,$r['estado']).'",50,"cont/pfrr_presuntos_montos.php","idPresuntop='.$r['cont'].'&numAccion='.$r['num_accion'].'&usuario='.$_REQUEST['usuario'].'&direccion='.$_REQUEST['direccion'].'")\'></a>';
				$tabla .= '</td>
				</tr>';
}
