...
$tipoPO = valorSeguro($_POST['tipoPO']);
$cf_ch = valorSeguro($_POST['cf_ch']);
$dgatic_ch = valorSeguro($_POST['dgatic_ch']);
$gf_ch = valorSeguro($_POST['gf_ch']);
