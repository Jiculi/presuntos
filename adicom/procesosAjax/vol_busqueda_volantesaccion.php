...
//--------------------------------------------------------------------------------------------------
$sql=$conexion->select("SELECT num_accion,direccion,abogado,detalle_de_estado_de_tramite AS ET,numero_de_pliego,prescripcion FROM po WHERE num_accion LIKE '%".$accion."%' order by num_accion asc ");
//--------------------------------------------------------------------------------------------------
