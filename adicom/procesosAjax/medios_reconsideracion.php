                ...
                <form name="nsat" id="nsat">
                    ...
                    <input type="hidden" name="id_actor_reqns" id="id_actor_reqns" value="<?php echo $r ['actor']; ?>"/>
						...
						<table class='feDif' width='80%' align='center'>
                         <tr>
                          ...
                          <tr >
                            ...
                            <td><input name="satn" id="satn" type="text"  class="redonda5" value = "<?php echo $prev5['folio']?>" readonly /></td>
                          </tr>
                            <tr>
                        <td class="etiquetaPo">Fecha del Oficio:</td>
                        <td><input type="text" name="satnf" id="satnf" class="redonda5" value = "<?php echo fechaNormal($prev5['fecha_oficio'])?>" readonly /></td>
                    </tr>
                          <tr >
                            <td class="etiquetaPo">Notificación del Oficio:</td>
                            <td><label for="monto5"></label>
                              <input type="text" name="satff" id="satff" class="redonda5" /></td>
                          </tr>
						</table>                        
                        <br />
                        <br />
					   ...
					   <input type="hidden" name="tipoForm" id="tipoForm" value="ofic_SAT" />
                          <input type='button' value='Guardar Fecha' class='submit_line' id="nssat"/>
                       </center>
				</form>
        </div>
        </td>        
                ...
                <table width="90%" class="feDif">
                    <tr>
                      <th colspan="2" align="center">
                         <?php if($ofprev == 0) {  ?>
                            <div class="mensajeRojo">No existe Oficio... <br /> <a href="?cont=medios_rr_oficios&nombre=<?php echo trim($r['actor']) ?>">Click aqui para crearlo</a></div>
                            <br> 
                            <br>
                         <?php } ?>
                      Notificacion al Presunto</th>
        ...
        <form name="formDili" id="formDili">
                <table width="90%" class="feDif">
                    ...
                    <tr>
                        ...
                        <td class="etiquetaPo">Oficio de notificación <br /> al actor:</td>
                        <td><input type="text" name="ofi_dil" id="ofi_dil" class="redonda5" value="<?php echo $not['folio'] ?>" readonly /></td>
                    </tr>
                    <tr>
                        <td class="etiquetaPo">Fecha del Oficio:</td>
                        <td><input type="text" name="fecha_ofi_dil" id="fecha_ofi_dil" class="redonda5" value="<?php echo fechaNormal($not['fecha_oficio']) ?>" readonly /></td>
                    </tr>
                    <tr>
                        <td class="etiquetaPo">Notificación del Oficio:</td>
