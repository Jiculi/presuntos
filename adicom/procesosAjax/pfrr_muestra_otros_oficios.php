...
//------------------------------------------------------------------------------
$sql = $conexion->select("SELECT * FROM pfrr_bitacora_adicional WHERE num_accion LIKE '%".$accion."%' AND status = 1 ",false);
            ...
            <div id="p2" class="todosContPasos pInactivo">
              ...
              $tabla = '
                        <table style="width:100%;" border="0" align="center" cellpadding="0" cellspacing="0" id="product-table" >
                            <tr>
								<th class="ancho100">Folio</th>
								<th class="ancho150">Acción</th>
								<th class="ancho100">Oficio</th>
								<th class="ancho50">Volante</th>
								<th class="ancho100">Fecha Volante</th>
								<th class="ancho100">Acuse Volante</th>
								<!-- <th>Asunto</th> -->
								<th class="ancho150">Remitente</th>
								<th class="ancho50">Seguimiento</th>
                            </tr>
                        </table>
                        ...
                        while($r = mysql_fetch_array($sql))
                        {
                            ...
                            $tabla .= '
									<tr>
										<td class="ancho100">'.$r['folio'].'</td>
										<td class="ancho150">'.$r['num_accion'].'</td>
										<td class="ancho100">'.$r['tipo_oficio_adicional'].'</td>
										<td class="ancho100">'.$r['oficio_tipo_oficio_adicional'].'</td>
										<td class="ancho100">'.fechaNormal($r['fecha_tipo_oficio_adicional']).'</td>
										<td class="ancho100">'.fechaNormal($r['acuse_tipo_oficio_adicional']).'</td>
										<!-- <td>'.$r['leyenda_tipo_oficio_adicional'].'</td> -->
										<td class="ancho150">'.$r['atiende_tipo_oficio_adicional'].'</td>
                                        <td class="ancho50" >
