...
//------------------------------------------------------------------------------
		...
		$tabla .= '
				<tr '.$estilo.'  >
					...
					<td class="ancho50" align="center"><center>'.$dir.'</center></td>
					<td class="ancho100">'.$ctrlInt.'</td>
					<td class="ancho100">';
						$tabla .= '<a href="#" title="Ver Información"  class="icon-5 info-tooltip" onclick=\'var cuadro2 = new mostrarCuadro(500,900," '.$r['num_accion'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$r['entidad'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.dameEstadoi($conecta,$r['estado']).'",50,"cont/medios_informacion_jn.php","id='.$r['id'].'&usuario='.$_SESSION['usuario'].'&direccion='.$_SESSION['direccion'].'")\'> </a>';
						$tabla .= "<a href=\"#\" title='Recurso de Reconcideración'  class='icon-1 info-tooltip' onclick=\"var cuadro5 = new mostrarCuadro(450,1100,'".$r['nombre']."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$r['num_accion']."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".dameEstadoi($conecta,$r['estado'])."',50,'cont/medios_juicio.php','idPresuntop=".$r['id']."&numAccion=".$r['num_accion']."&usuario=".$_SESSION['usuario']."&direccion=".$_SESSION['direccion']."&presunto=".urlencode($r['nombre'])."')\">  </a>";
						$tabla .= "<a href=\"#\" title='Recurso de Reconcideración'  class='icon-6 info-tooltip' onclick=\"var cuadro5 = new mostrarCuadro(450,1100,'".$r['nombre']."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$r['num_accion']."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".dameEstadoi($conecta,$r['estado'])."',50,'cont/medios_representantes_legales.php','idPresuntop=".$r['id']."&numAccion=".$r['num_accion']."&usuario=".$_SESSION['usuario']."&direccion=".$_SESSION['direccion']."&presunto=".urlencode($r['nombre'])."')\">  </a>";
						$tabla .= '</td>
				</tr>';
}
