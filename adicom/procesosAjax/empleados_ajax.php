...
//------------------------------------------------------------------------------
		...
		$tabla .= '
				...
				<td width="85" align="center">
						<a href="#" title="Ver Contrato" onclick=\'var cuadro4 = new mostrarCuadro(610,810,"Nombre: '.$r['nombre'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Dirección: '.$r['direccion'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;",50,"cont/emp_contrato.php","emp='.$r['usuario'].'&co='.$r['contrato'].'&usuario='.$_SESSION['usuario'].'&direccion='.$_SESSION['direccion'].'")\' >
						'.str_replace($valor,"<span class='b'>".$valor."</span>",$r['noempleado']).'
						</a>
				</td>
				
					<td width="215" align="left" >
						<a href="#" title="Ver Credencial" onclick=\'var cuadro1 = new mostrarCuadro(310,410,"Nombre: '.$r['nombre'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Dirección: '.$r['direccion'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;",50,"cont/emp_historial.php","emp='.$r['usuario'].'&id='.$r['id'].'&usuario='.$_SESSION['usuario'].'&direccion='.$_SESSION['direccion'].'")\' >
