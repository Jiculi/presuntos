        ...
        <form method="POST" name="presunto_guarda_pfrr" id="presunto_guarda_pfrr">
          <table width="100%" align="center" class="tablaPasos " >
            ...
            <tr >
              ...
              <input name="oficio_citatorio"  type="text" size="30" class="redonda5"  id="oficio_citatorio" value="<?php echo $ofiCitatorio  ?>" readonly="readonly" <?php echo $disabled  ?>></td>
            </tr>
            <tr >
              <td class="etiquetaPo">Fecha del Oficio:</td>
              <td><label for="monto"></label>
              <input name="fecha_oficio_cit"  type="text"  class="redonda5"  id="fecha_oficio_cit" value="<?php echo $ofiFecha  ?>"readonly="readonly" <?php echo $disabled  ?>></td>
            </tr>
            <tr >
              <td class="etiquetaPo">Fecha de Notificación:</td>
              <td><label for="monto"></label>
              <input name="fecha_noti_cit"  type="text"  class="redonda5"  id="fecha_noti_cit" value="<?php echo $ofiNotificacion ?>" readonly="readonly" <?php echo $disabled  ?>></td>
            </tr>
            <tr >
            ...
            <tr >
              ...
              <input name="fecha_citacion"  type="text"  class="redonda5"  id="fecha_citacion" value="<?php echo $fechaAudiencia ?>" readonly="readonly" <?php echo $disabled  ?>></td>
            </tr>
            <tR>
