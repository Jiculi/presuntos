...
<head>
    ...
    <link rel="stylesheet" href="css/frListaVencimiento.css">
   ...
   <script type="text/javascript" src="js/jquery-ui-1.12.1.custom/jquery-ui.min.js"></script> 
    ...
    <script type="text/javascript" src="e/frListaVencimiento.js"></script>
...
<body>
    ...
    <div id="listajuicios">
        <div class="navbarJuicios">
            <a href="#" class="logo">En Elaboración de Resolución y en su caso PDR</a>
        ...
        <div id = "contenedor">
          <table id="juicios" class="display nowrap" style="width:100%">
            ...
            <th></th>
                    ...
                    <th>nivel</th>
                    <th>subdirector</th>
                    <th>Cierre Instrucción</th>
                    <th>Límite Resolución</th>
                    <th>Vencimiento</th>
