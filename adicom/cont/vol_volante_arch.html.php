...
<div id="impresion" style="position:fixed; right:390px; z-index:1000">
...
$tablaVol = '
    <table width="100%" style="font-size:12px; font-family:Arial, Helvetica, sans-serif;border:1px solid #333;-moz-border-radius:5p;-webkit-border-radius: 5px; border-radius: 5px;">
        <tr>
          ...
          <td style="">
          <br>
		  	<div align="center"><strong>DIRECCIÓN GENERAL DE RECURSOS MATERIALES Y SERVICIOS</strong></div>
		  	<div align="center"><strong>DIRECCIÓN DE RECURSOS MATERIALES</strong></div>
		  	<div align="center"><strong>SUBDIRECCIÓN DE ADMINISTRACIÓN DE DOCUMENTOS</strong></div>
		  </td>
