...
$sql = $conexion->select("SELECT oficio,sicsa,oficioNotEntidad,oficioNotOIC,status,idArchivo FROM opiniones_historial WHERE num_accion = '$accion' AND status = 1 ",false);
?>
