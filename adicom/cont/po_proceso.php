			...
			echo $fecha_prescripcion;?>'<?php echo $row_DetailRS1['prescripcion']; ?> />
              <table width="90%" align="center" class="tablaPasos ">
                ...
                <tr valign="baseline">
                  ...
                  <td>
                  	<input  tabindex="3" style="float:left" id="acuse_oficio_notificacion_entidad" name="acuse_oficio_notificacion_entidad"  type="text"  class="redonda5"  value=''  size="12" <?php //echo $disabledEF ?>/>
                  ...
                  <td><input  tabindex="6" style="float:left" id="acuse_oficio_notificacion_oic" name="acuse_oficio_notificacion_oic"  type="text"  class="redonda5"  value=''  size="12"  <?php // echo $disabledICC ?>/>
