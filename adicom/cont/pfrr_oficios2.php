	...
	else  
	{
		...
		({
			...
			{ 
				...
				if(opcion == 'otros_PFRR' || opcion == 'sat_PFRR' || opcion == 'ef_PFRR' || opcion == 'icc_PFRR' || opcion == 'imss_PFRR' || opcion == 'issste_PFRR' || opcion == 'tribunal_repo') 
				{
					$$("#cargo").attr("readonly",false); 
					$$("#remitente").attr("readonly",false);
					$$("#dependencia").attr('readonly',false);	 
                     ...
                     <tr>
                        ...
                        <td>
                          <select name="tipoOficio" id="tipoOficio" class="redonda5" onchange="verificaOpcion(this.value)" >
                            ...
                            <option value="tribunal_repo_pfrr">TRIBUNAL - Reposición de Procedimiento</option>
