  ...
  <link rel="stylesheet" href="css/estilo.css" type="text/css" media="screen" title="default" />
    ...
    <!--  start product-table ..................................................................................... -->
		...
		<tr>
			...
			<tr>
                <td class="etiquetaPo" > Fecha de Acuerdo de Inicio: </td>
                <td >
                   <input type="text" name="acu_inicio" id="acu_inicio" class="redonda5" size="10"/>
                </td>
                
                <td class="etiquetaPo" > Fecha de Ultima Actuación: </td>
                <td >
			...
			<tr>
                ...
                <td>
					...
					<?php
					$sql = $conexion->select("SELECT nombre, nivel FROM usuarios WHERE LENGTH(nivel) = 1 AND perfil = 'Director' and status != '0' ORDER BY nivel",false);
				...
				<td class="etiquetaPo" > Limite Emisión de la Resolución: </td>
                <td >
			...
			<tr>
                ...
                <td>
                 ...
                 <option value="" selected="selected">Elegir</option>
                 <?php
                 $sql = $conexion->select("SELECT cp FROM pfrr group by cp ORDER BY cp desc",false);
                 
                 while($r = mysql_fetch_array($sql))
                    echo '<option value="'.$r['cp'].'">'.$r['cp'].'</option>';
                ...
                <td>
                 ...
                 <option value="" selected="selected">Elegir</option>
                 <?php
                 $sql = $conexion->select("SELECT nombre, nivel FROM usuarios WHERE LENGTH(nivel) = 3 and status != '0' ORDER BY nivel",false);
				...
				<select name='jefe_depto' id='jefe_depto' class="redonda5" >
                 <option value="" selected="selected">Elegir</option>
                 <?php
                 $sql = $conexion->select("SELECT nombre, nivel FROM usuarios WHERE LENGTH(nivel) = 5 and status != '0' ORDER BY nivel",false);
              ...
              <tr>
                ...
                <td>
                  <select name='edoTram' id='edoTram' class="redonda5" onchange="Sicsa()">
                    ...
                    <option value="15">En proceso de notificar oficio(s) citatorio</option>
					...
					<option value="27">DT por no Solventación</option>
					<option value="28">Iniciado</option>
					<option value="29">Desahogo</option>
					<option value="45">Resolución Impugnada</option>
					<option value="9">Resoluciones</option>
              ...
              <tr>
                ...
                <td >
                  <select name='tipo_devolucion' id='tipo_devolucion' class="redonda5" >
                    <option value="" selected="selected">Elegir</option>
...
<td class="etiquetaPo" >Monto de incio:</td>
                <td>
                  <input type="text" name="inicio" id="inicio" class="redonda5" size="30"/>
                </td>
                ...
                <tr>
                  ...
                  <td colspan="6">
                    ...
                    <table width="100%" class="tds">
                      ...
                      <tr>
                        <td><input type="checkbox" name="inicioCh" id="inicioCh" checked="checked"  /> Monto de Inicio</td>
