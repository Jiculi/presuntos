...
//----------------------------------------- DATEPICKER CIERRE SOBRESEIMIENTO ------------------------------------------------
//--------------------------------------------------------------------------------------------------------------
	$$( "#fechaCierreInstruccion_2" ).datepicker({
	 // dateFormat: formatoFecha,
      changeMonth: false,
      numberOfMonths: 1,
	  showAnim:'slideDown',
	  ...
	  */
	  //beforeShowDay: noLaborales,
              onClose: function( selectedDate ) 
              {
                var fechaMas45 = sumaNaturales(selectedDate,45); 
                $$("#fechaUltimaActuacionMas45").val(fechaMas45);  
              }
      //onClose: function( selectedDate ) {
        //$$( "#fecha_accion_omision1" ).datepicker( "option", "maxDate", selectedDate );
      //}
...
if($pasoUAA)
{
	...
	$fecha90 = strtotime ( '+90 day' , strtotime ( $r['cierre_instruccion'] ) ) ;
...
//------------------- MENSAJE DE ESPERA ACCION ------------------------------
//---------------------------------------------------------------------------
if($r['detalle_edo_tramite'] == 12 || $r['detalle_edo_tramite'] == 14)
{
	if(ACTIVAPESTANAS == false)
	echo "<script>	
...
//---------------------------------------------------------------------------
if( dameEdoNumOrden(dameEdoTramite($accion)) > dameEdoNumOrden(15) && $r['detalle_edo_tramite'] != 18 && $r['detalle_edo_tramite'] != 31 && $r['detalle_edo_tramite'] != 19 && $r['detalle_edo_tramite'] != 28 && $r['detalle_edo_tramite'] != 22 && $r['detalle_edo_tramite'] != 29 && $r['detalle_edo_tramite'] != 23 && $r['detalle_edo_tramite'] != 24 && $r['detalle_edo_tramite'] != 25  && $r['detalle_edo_tramite'] != 26 && $r['detalle_edo_tramite'] != 45)
{
	if(ACTIVAPESTANAS == false)
	echo "<script>
...
/*	//$onclickP1 = "onclick = \" muestraError('p1','No puede realizar una recepcion si no ha devuelto (Asistido Jurídicamente) esta accion') \" ";
	IF($r['fecha_acuerdo_inicio'] == "" OR $r['fecha_acuerdo_inicio'] == "0000-00-00"){ $onclickP2 = "onclick='muestraPestana(2)'"; }
	IF($r['fecha_acuerdo_inicio'] == "" OR $r['fecha_acuerdo_inicio'] == "0000-00-00"){ $onclickP3 = "onclick='muestraPestana(3)'"; }
	IF($r['fecha_acuerdo_inicio'] != "" || $r['fecha_acuerdo_inicio'] != "0000-00-00"){	$onclickP4 = "onclick='muestraPestana(4)'";	}
	
	IF($r['fecha_acuerdo_inicio'] == "" OR $r['fecha_acuerdo_inicio'] == "0000-00-00"){	$txtPaso3 = "pasosActivo"; }
	IF($r['fecha_acuerdo_inicio'] != "" || $r['fecha_acuerdo_inicio'] != "0000-00-00"){	$txtPaso4 = "pasosActivo"; }
	
	IF($r['fecha_acuerdo_inicio'] == "" OR $r['fecha_acuerdo_inicio'] == "0000-00-00"){ $acceso2 = "pfAccesible";  }
	IF($r['fecha_acuerdo_inicio'] == "" OR $r['fecha_acuerdo_inicio'] == "0000-00-00"){ $acceso3 = "pfAccesible"; }
	IF($r['fecha_acuerdo_inicio'] != "" || $r['fecha_acuerdo_inicio'] != "0000-00-00"){	$acceso4 = "pfAccesible";  }
	
	IF($r['fecha_acuerdo_inicio'] == "" OR $r['fecha_acuerdo_inicio'] == "0000-00-00"){ echo "<script>	$$(function() {	$$('#p3').fadeIn();	});	</script>"; }
	//IF($r['fecha_acuerdo_inicio'] != "" || $r['fecha_acuerdo_inicio'] != "0000-00-00"){	echo "<script>	$$(function() {	$$('#p4').fadeIn();	});	</script>"; }*/
	IF($r['fecha_acuerdo_inicio'] == "" OR $r['fecha_acuerdo_inicio'] == "0000-00-00")
	{
		$onclickP2 = "onclick='muestraPestana(2)'";	
		$onclickP3 = "onclick='muestraPestana(3)'";	
	...
	else IF($r['fecha_acuerdo_inicio'] != "" || $r['fecha_acuerdo_inicio'] != "0000-00-00")
	{
...
//---------------------------------------------------------------------------
if($r['detalle_edo_tramite'] == 29 || $r['detalle_edo_tramite'] == 23 || $r['detalle_edo_tramite'] == 24 || $r['detalle_edo_tramite'] == 25 || $r['detalle_edo_tramite'] == 26 || $r['detalle_edo_tramite'] == 45)
{
	//$onclickP1 = "onclick = \" muestraError('p1','No puede realizar una recepcion si no ha devuelto (Asistido Jurídicamente) esta accion') \" ";
	$onclickP2 = "";	
	$onclickP3 = "";	
...
<div class="contPasos">
        ...
        <div id="p2" class="todosContPasos pInactivo">
			...
			$$(function() {
              ...
              <table width="100%" align="left" class="tablaPasos ">
                <tr valign="baseline">
                  <td width="13%" height="50"  align="left" nowrap class="etiquetaPo">Oficio de Devoluci&oacute;n:</td>
                  <td width="9%" >
                 <?php
				    echo "<input name='oficio_de_devoluciondtns' id='oficio_de_devoluciondtns' class='redonda5' type='text' value='".stripslashes($ofi['Folio'])."'  size = '30'  > " ?>
                  </td>
                  <!-- ---------------------------- ----------------------------->
                  <!-- ---------------------------- ----------------------------->
                  <td width="39%"  rowspan="50" >
                     <center>
                         <table class="tabladtns" width="90%" align="center">
                            ...
                            <tr>
                              ...
                              <td valign="top"  width="25%"   class=""><p>
                                    <input type="checkbox" name="cien" id="cien">
                                    <label for="cien">Importe menos de 100,000
                                    </td></label>
                                    </p>
                                <p>
                                 <td valign="top"  width="25%"   class="">
                  ...
                  <label for="otros">Otros</label>
                               ...
                               <input type="hidden" name="otrost" id="otrost"  class="redonda5" >
                    <label for="otros">             </label>       
                           ...
                           <tr>
                              ...
                              <td valign="top" width="11%"   class=""><input type="checkbox" name="mezcla" id="mezcla">
                          ...
                          <tr valign="baseline">
                              <td valign="top" width="11%" class=""><input type="checkbox" name="datos" id="datos">
                                <label for="datos">Falta de datos 
                                  personales (PR)
                              </label></td> 
                              <td valign="top"  width="11%"  class=""><input type="checkbox" name="ilegible" id="ilegible">
                ...
                <tr valign="baseline">
                  ...
                  <td><input  tabindex="3" id="acusedev" name="acusedev" type="text"  class="redonda5" value='' size = "15" ><a href="#" onClick="getElementById('acusedev').value=''" style="float:right; margin:0 40px 0 0" title="Borrar fecha" class="icon-2 info-tooltip"></a></td>
            ...
            <form action="#" method="POST" name="formpro" id="notiiccpfrr" onSubmit="return false">
			  <table width="100%" border="0" align="center" class="tablaPasos ">
				...
				<tr>
				  ...
				  <td><input  tabindex="2" style="float:left;" id="oficio_not_icc_pfrr" name="oficio_not_icc_pfrr" type="text"  class="redonda5" value='<?php echo stripslashes($ofi['folio']) ?>' size="20" > <a href="#" style=" " ></a></td>
			    </tr>
                <tr valign="baseline">
				  ...
				  <td><input  tabindex="2" style="float:left;" id="fecha_not_icc_pfrr" name="fecha_not_icc_pfrr" type="text"  class="redonda5" value='<?php echo stripslashes(fechaNormal($ofi['fecha_oficio'])) ?>' size="12" > <a href="#" style=" margin:0 0 0 5px" ></a></td>
</tr>
 ...
 <!-- ----------------------------- DIV ACUERDO DE INICIO --------------------------------- -->
            ...
            <form action="#" method="POST" name="formpro" id="acuerdoinicio" onSubmit="return false">
			  <table width="100%" border="0" align="center" class="tablaPasos ">
				...
				<tr valign="baseline">
                  ...
                  <center>
                <br><br>
				<?PHP  if($r['fecha_acuerdo_inicio'] != "" || $r['fecha_acuerdo_inicio'] != "0000-00-00" ) {  ?>
                <input type="button" class="submit-login" alt="Guardar" value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Guardar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" name="Registrar" id="RegistrarProce"   onclick="generapfrr()" /> 
				<?PHP } else {echo "La fecha del acuerdo de inicio es: "; echo $r['fecha_acuerdo_inicio'];
				echo "</br> Para continuar selecione la pestaña de: NOTIFICACIÓN AL ICC";
				}?>
                    </center>       
        		</td>
			    </tr>
    ...
    <div id="p9" class="todosContPasos pInactivo">
        <div style="float:right"><img src="images/help.png" /></div>
        <h3 class="poTitulosPasos">Opinión Técnica de la UAA   </h3><h5>*(Si no genera oficio de Opinión Técnica seleccione la pestaña de "ULTIMA ACTUACIÓN")</h5>
        <?php
        ...
        <table class='feDif' width='80%' align='center'>
        	<tr >
              ...
              <input name="folioUAA"  type="text"  class="redonda5"  id="folioUAA" value="<?php echo $rUA['OficioFolio'] ?>"  <?php //echo $disabledUA ?> ></td>
            </tr>
            
        	<tr >
              <td class="etiquetaPo">Fecha del Oficio:</td>
              <td><label for="monto"></label>
              <input name="fechaUAA"  type="text"  class="redonda5"  id="fechaUAA" value="<?php echo fechaNormal($rUA['fecha_oficio']) ?>"  <?php //echo $disabledUA ?> ></td>
            </tr>
            
        	<tr >
              <td class="etiquetaPo">Acuse del Oficio:</td>
              <td><label for="monto"></label>
              <input name="fechaAcuseUAA"  type="text"  class="redonda5"  id="fechaAcuseUAA" value=""  <?php //echo $disabledUA ?> ></td>
            </tr>
        </table>
    ...
    <div id="p8" class="todosContPasos pInactivo">
        ...
        <table class='feDif' width='80%' align='center'>
        	<tr >
              ...
              <td><label for="monto"></label>
              <input name="fechaUltimaActuacion"  type="text"  class="redonda5"  id="fechaUltimaActuacion" value="<?php echo $fechaUAA ?>"  <?php echo $disabledUltimaActuacion ?> ></td>
            </tr>
...
<!--  CIERRE DE INSTRUCCION ------------------------------------------------------------------- -->
	...
	<!--  CIERRE DE INSTRUCCION ------------------------------------------------------------------- -->
     ...
     <div id="p6" class="todosContPasos pInactivo">
        <div style="float:right"><img src="images/help.png" /></div>
        <h3 class="poTitulosPasos">Cierre de Instrucción o Acuerdo de Sobreseimiento	</h3>
        ...
        <table class='feDif' width='80%' align='center'>
			...
			<tr >
              <td class="etiquetaPo">Límite de 90 días:</td>
              <td><label for="monto"></label>
              <input name="fechaUltimaActuacionMas90"  type="text"  class="redonda5"  id="fechaUltimaActuacionMas90" value="<?php echo $fecha90 ?>" readonly <?php echo $disabledfechaCierreInstruccion ?> ></td>
            </tr>
        </table>
         <tr>
           <td colspan='2'><br><center> <input type='button' value='Guardar Fecha' class='submit_line' onclick='FecierreInstruccionx("<?php echo $cambiaEdo ?>")' <?php echo $disabledfechaCierreInstruccion ?> /> </center> </td> </tr>
   ...
   <!--  SOBRESEIMIENTO ------------------------------------------------------------------- -->     
           ...
           <td>   
           <center>
         <form name="formCierreInstruccion_2">
         <table width='55%' height="84" align='center' class='feDif'>
        	<tr >
              <td width="41%" class="etiquetaPo">Acuerdo de Sobreseimiento:</td>
              <td width="59%"><label for="monto"></label>
              <input name="fechaCierreInstruccion_2"  type="text"  class="redonda5"  id="fechaCierreInstruccion_2" value="" readonly <?php echo $disabledfechaCierreInstruccion ?> ></td>
            </tr>
			<tr >
              <td class="etiquetaPo">Límite de 45 días:</td>
              <td><label for="monto"></label>
              <input name="fechaUltimaActuacionMas45"  type="text"  class="redonda5"  id="fechaUltimaActuacionMas45" value="<?php echo $fecha45 ?>" readonly <?php echo $disabledfechaCierreInstruccion ?> ></td>
            </tr>
        </table>
         <tr><td colspan='2'><br><center> <input type='button' value='Guardar Fecha' class='submit_line' onclick='FecierreInstruccionxx("<?php echo $cambiaEdo ?>")' <?php echo $disabledfechaCierreInstruccion ?> /> </center> </td> </tr>
