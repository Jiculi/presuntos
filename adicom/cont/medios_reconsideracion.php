...
if($_REQUEST['edotram'] == 36)
{
	...
	$query10= "SELECT * FROM `medio_historial` WHERE `Tipo` = 'diligencias_UAA' AND `Procedimiento` LIKE '%".$_REQUEST['recurso_reconsideracion']."%' LIMIT 1";
	$sq10 = $conexion->select($query10,false);
	$prev10= mysql_fetch_array($sq10);
	$todil1 = mysql_num_rows($sq10);
		if($todil1 == 0){ $desdi1="enable"; $ocdil="button"; }else{ $desdi1="disabled"; $ocdil="hidden"; }
...
//------Se desplega calendario para acusar la fecha de notificación al SAT en Acuerdo de Admisión/Desechamiento
	$$( "#satff1" ).datepicker({
	 // changeMonth: false,
      numberOfMonths: 1,
	  showAnim:'slideDown',
...
//------Se desplega calendario para acusar la fecha de notificación de diligencias
	...
	// minDate: "01/08/2017",
	  ...
	  //------Se despliega calendario para acusar la fecha de notificación a la EF
	$$( "#notof_ef" ).datepicker({
	//  changeMonth: false,
      numberOfMonths: 1,
	  showAnim:'slideDown',
...
//------Se despliega calendario para acusar la fecha de notificación al ICC
	$$( "#notof_ic" ).datepicker({
	//  changeMonth: false,
      numberOfMonths: 1,
	  showAnim:'slideDown',
...
//---- EDO 33 REQUERIMIENTO DE INFORMACION AL RECURRENTE DEL RECURSO DE RECONSIDERACION--------------------------prue1
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type='button' name='extemporaneo' id='extemporaneo' value='extemporaneo'  class='submit_line'  />
                      ...
                      <!---th colspan="2" align="center">
                         <?php //if($ofprev == 0) {  ?>
                            <div class="mensajeRojo">
                              ...
                              <br> 
                      <p class="etiquetaPo">Notificacion al Presunto</p>
                              <p>&nbsp;</p>
                              <p>&nbsp;</p>
                ...
                <form name="nsat1" id="nsat1">
					...
					<input type="hidden" name="ntr" id="ntr" value="<?php echo $r ['detalle_edo_tramite']; ?>"/>
                        ...
                        <td><input type="text" name="satnf" id="satnf" class="redonda5" value = "<?php echo fechaNormal($prev7['fecha_oficio'])?>" <?php echo $desn1 ?> readonly /></td>
                            ...
                            <td class="etiquetaPo">Notificación del Oficio:</td>
                            <td>
                              <input type="text"  name="satff1" id="satff1" class="redonda5" value = "<?php echo fechaNormal($prev8['Fecha_Acuse'])?>" <?php echo $desn1 ?> /></td>
                          </tr>
						<tr>
        ...
        <form name="formNotifica" id="formNotifica">
                <table width="90%" class="feDif">
                    ...
                    <tr>
						...
						<?php 
						$querysh= "SELECT * FROM medio_historial WHERE Procedimiento = '".$r['recurso_reconsideracion']."' and Tipo = 'rr_notifica' ";
		$sqlchs = $conexion->select($querysh,false);
		$fechanotsat= mysql_fetch_array($sqlchs);
		$blokacuse = mysql_num_rows($sqlchs);
			if($blokacuse == 0){ $muetrac="enable"; $botabil="button"; }else{ $muetrac="disabled"; $botabil="hidden"; } 
						?>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="fecha_acuse_oficio_noti_actor" id="fecha_acuse_oficio_noti_actor" class="redonda5" value="<?php echo fechaNormal($fechanotsat['Fecha_Acuse']); ?>" <?php echo $muetrac; ?>  /></td>
                    </tr>
                    <tr>
                        <td colspan="2" align="center">
						</br>
						<center>
                            ...
                            <input type="<?php echo $botabil; ?>" name="Guardar" value="Guardar" class="submit_line" id="guardaNot"/>
                        </center>
						</td>
                    </tr>
                </table>
     ...
     <h3>Resolución del Recurso de Reconsideración </h3><br> 
        ...
        <form name="formDili" id="formDili">
                <table width="90%" class="feDif">
                    ...
                    <tr>
                        <td class="etiquetaPo">Notificación del Oficio:</td>
                        <td><input type="text"  name="fecha_acuse_oficio_dil" id="fecha_acuse_oficio_dil" class="redonda5" value="<?php echo fechaNormal($prev10['Fecha_Acuse']) ?>" <?php echo $desdi1 ?> /></td>
                    </tr>
                    <tr>
                        <td colspan="2" align="center"><br />
                ...
                <form name="NotiresoT" id="NotiresoT">
					   ...
					   <table class='feDif' width='80%' align='center'>
                            ...
                            <tr >
                              <td class="etiquetaPo">Fecha de Notificación:</td>
                              <td><label for="monto"></label>
                              <input type="text"  name="notofact" id="notofact" class="redonda5" value="<?php if($tonot0 == 1) echo fechaNormal($prev11['Fecha_Acuse'])  ?>" <?php echo $desnot0 ?> /></td>
                         ...
                         <tr>
                          ...
                          <tr >
                            ...
                            <td><label for="monto5"></label>
                              <input type="text" name="notofsat" id="notofsat" class="redonda5" value="<?php if($tonota0 == 1) echo fechaNormal($prev12['Fecha_Acuse'])  ?>" <?php echo $desnota0 ?>/></td>
                          </tr>
						</table>                        
                        <br />
                        <br />
                ...
                <form name="Notieficc" id="Notieficc">
					   ...
					   <table class='feDif' width='80%' align='center'>
                            ...
                            <tr >
                              <td class="etiquetaPo">Fecha de Notificación:</td>
                              <td><label for="monto"></label>
                              <input type="text"  name="notof_ef" id="notof_ef" class="redonda5" value="<?php if($tonoef == 1) echo fechaNormal($prevef['Fecha_Acuse'])  ?>" <?php echo $desnotef ?> /></td>
						...
						<table class='feDif' width='80%' align='center'>
                         <tr>
                          ...
                          <tr >
                            <td class="etiquetaPo">Fecha de Notificación:</td>
                            <td><label for="monto5"></label>
                              <input type="text" name="notof_ic" id="notof_ic" class="redonda5" value="<?php if($tonotic == 1) echo fechaNormal($previc['Fecha_Acuse'])  ?>" <?php echo $desnotic ?>/></td>
                          </tr>
						</table>                        
                        <br />
                        <br />
