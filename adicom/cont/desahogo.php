...
function buscaAccionAvanzadah(envio,limit)
{
	if(envio != "excel"){
		$$("#conTabla2").slideUp();
	...
	if(envio != "excel"){
		...
		ajax=objetoAjax();
		ajax.open("post","procesosAjax/reporte_ja.php",true);
		...
		window.location.href = "procesosAjax/rep_jaime_excel.php? "+"ef="+ef;
	}
...
<div id="content-table-inner">
  <link rel="stylesheet" href="css/estilo.css" type="text/css" media="screen" title="default" />
    <div class="conTabla2" id="conTabla2">
        <!--  start product-table ..................................................................................... -->
        <form onkeypress="if(event.keyCode == 13) buscaAccionAvanzadah()">
              ...
              <table border="0" width="50%" align="center">
                <tr>
                  <td align="center">
                    ...
                    <input type="button" value="     Buscar      " name="Buscar" onclick="buscaAccionAvanzadah()" class="submit-login" />
        </FORM>
    ...
    <div id="divDescarga" style="display:none;  padding:11px; float:right; margin:0 10px; width:230px" class="submit-login redonda5" >
    	<center> <span> <input type="button" value="Descargar en Excel" class="redonda5" onclick="buscaAccionAvanzadah('excel')" /></span> </center>
    </div>
