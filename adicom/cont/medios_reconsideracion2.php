...
if($_REQUEST['edotram'] == 41 or 42 or 43)
{
...
if($_REQUEST['edotram'] == 41.1 or 42.1 or 43.1)
{
...
//---- EDO 33 REQUERIMIENTO DE INFORMACION AL RECURRENTE DEL RECURSO DE RECONSIDERACION--------------------------
 ...
 //---- EDO 36 CIERRE DE INSTRUCCIÓN --------------------------
  ...
  // Guarda fechas de Notificacion para El presunto  ------------------------------------------- :
$$("Fechatipores").click(function(){
...
// Guarda fechas de Notificacion para El  SAT ------------------------------------------- :
$$("Fechatiporesat").click(function(){

	  	var datosUrl = $$("#NotiresoT2").serialize();
		
		if(comprobarForm("NotiresoT2"))
		{
			var confirma = confirm("Cambiará el estado a: \n\n - <?php echo dameEstado(38); ?>  \n\n ¿Desea continuar?");
			if(confirma)
			{
...
if($r['detalle_edo_tramite'] == 41 || $r['detalle_edo_tramite'] == 42 || $r['detalle_edo_tramite'] == 43)
{
...
//if ($r['detalle_edo_tramite'] == 35.1){$edo35 = 351;}
	
if($edo35 ==351 || $edo35 ==35.1)
{
     ...
     <h3>Notificación del Acuerdo </h3><br> 
        ...
        <form name="formNotifica" id="formNotifica">
                <table width="90%" class="feDif">
                    ...
                    <tr>
                        ...
                        <input type="text" name="accion_not" id="accion_not" value="<?php echo $r['num_accion'];?>"/>
						<input type="text" name="procedimiento_not" id="procedimiento_not" value="<?php echo $r ['recurso_reconsideracion'];?>"/>
                       
                        <input type="text" name="id_actor_not" id="id_actor_not" value="<?php echo $r ['actor']; ?>"/>         
                        <input type="text" name="edtram" id="edtram" value="<?php echo $_REQUEST['edotram']; ?>"/>
						<input type="text" name="us_not" id="us_not" value="<?php echo $_REQUEST['usuario'] ?>"/>
						<!-- hidden-->
                    ...
                    <tr>
                        <td colspan="2" align="center"><br />
                            <input type="hidden" name="tipoForm" id="tipoForm" value="rr_not_acuerdo" />
        ...
        <div id='paso_5' class="divsEdos">
            ...
            <br />
                ...
                <table width="60%" class="feDif">
                    ...
                    <tr>
							<input type="text" name="accion_ci" id="accion_ci" value="<?php echo $r['num_accion'];?>"/>
							<input type="text" name="procedimiento_ci" id="procedimiento_ci" value="<?php echo $r ['recurso_reconsideracion'];?>"/>
                       		<input type="text" name="id_actor_ci" id="id_actor_ci" value="<?php echo $r ['actor']; ?>"/>         
							<input type="text" name="us_ci" id="us_ci" value="<?php echo $_REQUEST['usuario'] ?>"/>
                        <td colspan="2" align="center"><br />
                        <br />                                          
                        <br />
                        <br />
						<input type="text" name="tipoForm" id="tipoForm" value="rr_cierreins" />
        ...
        <div id='paso_6' class="divsEdos">
            ...
            <br />
                ...
                <table width="60%" class="feDif">
                    <tr>
					<input type="text" name="accion_emr" id="accion_emr" value="<?php echo $r['num_accion'];?>"/>
						<input type="text" name="procedimiento_emr" id="procedimiento_emr" value="<?php echo $r ['recurso_reconsideracion'];?>"/>
                       
                        <input type="text" name="id_actor_emr" id="id_actor_emr" value="<?php echo $r ['actor']; ?>"/>
						<input type="text" name="us_emr" id="us_emr" value="<?php echo $_REQUEST['usuario'] ?>"/>
                    <br /><br /><br />
 ...
 <center>          						         
            <div id="notificacionTESOFE" class="notiVarias">
					   ...
					   <table class='feDif' width='80%' align='center'>
                            ...
                            <tr >
                              ...
                              <input name="oficioT"  type="text"  class="redonda5"  id="oficioT" value="<?php echo $resact['folio'] ?>" readonly <?php echo $disabledfechaCierreInstruccion ?> <?php echo $disableP ?> ></td>
                             </td>	 
                            </tr>
                            <tr >
                          ...
                          <input name="tipoResolucionTESOFE"    id="tipoResolucionTESOFE" type="hidden" value="<?php echo $tipoRes ?>" readonly <?php echo $disabledfechaCierreInstruccion ?> <?php echo $disableE ?>>
						  <input name="tipoResolucionTESOFE"    id="tipoResolucionTESOFE" type="hidden" value>
						  </td>
                          <br><br> 
						  <center>
       ...
       <div id="notificacionTESOFE" class="notiVarias">
                     <form name="NotiresoT2">
                        ...
                        <table class='feDif' width='20%' align='center'>
                          <tr>
                          ...
                          <tr >
                            <td class="etiquetaPo">Oficio:</td>
                            <td><input name="oficioT2"  type="text"  class="redonda5"  id="oficioT2" value="<?php echo $ressat['folio'] ?>" readonly="readonly" <?php echo $disabledfechaCierreInstruccion ?> <?php echo $disableP ?> /></td></td>
                        ...
                        <br />
                       <center>
                          <input type='button' value='Guardar Fecha' class='submit_line' onclick='Fechatiporesat(&quot;<?php echo $cambiaEdo ?>&quot;,&quot;<?php echo $tipoRes ?>&quot;,&quot;tesofe&quot;)' <?php echo $disabledfechaCierreInstruccion ?> <?php echo $disableT ?>/>
                       </center>
