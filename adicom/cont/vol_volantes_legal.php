...
function cargaSelect(estado)
{
	...
	if(estado == 99)
	{
		...
		$$("select[name='movimiento'] option[value='100']").show();
...
function completaRemitentes(accion,tipo,seleccion)
{
	...
	//mostramor asunto dependiendo la seleccion
		if(seleccion == 104) {
		$$("#asunto").val('La oficina del AEGF remitió a esta DGR el PO firmado. Se inició trámite de certificación y el proceso para su notificación correspondientes.');		
				$$.ajax
		({
			beforeSend: function(objeto)
			{
			...
			type: "POST",
			url: "procesosAjax/volante_remitente.php",
	...
	if(seleccion == 100) {
		$$("#asunto").val('La UAA remite a esta DGR la Solicitud de Aclaración para su asesoría jurídica.');		
...
$$(function() 
{
	...
	$$("#accionvolante").autocomplete({
	 //source: "procesosAjax/po_buscar_accion_otros_oficios.php?direccion= " /* este es el formulario que realiza la busqueda */
			source: function( request, response ) {
					...
					$$.ajax({
						...
						type: "POST",
						url: "procesosAjax/vol_busca_accionlegal.php",
						dataType: "json",
						data: {
							term: 	request.term,
						},
	 ...
	 function( event, ui ) {  
		...
		$$("#remitente").val(ui.item.remi);
		$$("#cargo").val(ui.item.cargo);
		$$("#dependencia").val(ui.item.depen);
...
<div id="pagVolantes" style="padding:10px 20px;background:#F5D0A9" class="redonda10">    <!--
    ...
    <div id='p1' class=" redonda10 todosContPasos" >
        ...
        <tr>
            <td width="25%" valign="top">
                <div class="volanteDivCont redonda5"  style="height:200px;">
                    ...
                    <td>
                        ...
                        <input type="hidden" name="acccionPo" id="acccionPo" />
                          ...
                          <select name="movimiento" id="movimiento" style="width:200px"  class="redonda5 inputVolantes  inputsSig " onchange="completaRemitentes($$('#accionVol').val(),'remitentesUAA',this.value)" >
                            ...
                            <optgroup class="grupo grupoPO" label="Solciitud de Aclaración... " class="PO">
                                <option class="opciones PO" value="100" class="PO"> - <?php echo dameEstado(100) ?></option>
                                <option class="opciones PO" value="104" class="PO"> - <?php echo dameEstado(104) ?></option>
                                <option class="opciones PO" value="otros" class="PO"> - Otros </option>
                             </optgroup>
            ...
            <td  width="25%" >
            <div class="volanteDivCont redonda5"  style=" ">
            <table  align="center" width="100%" border="0" class="tablaPasos tablaVol">
              <tr>
          ...
          <td valign='top' width="25%" >
            ...
            <td  width="25%" >
                <div class="volanteDivCont redonda5" id="tablaCral"  style="height:100px;">
                <table align="center" width="100%" border="0" class="tablaPasos tablaVol" >                        
                    <tr>
       ...
       <tr>
            ...
            <!-- -------------------------------------------------------------- -->
            	<div class="volDivAcci redonda5" id="contAcciones" style="height:330px; overflow:auto; ">
                    ...
                    <form name="todasAccionesVol" id="todasAccionesVol" enctype="application/x-www-form-urlencoded" method="post" >
                        <div>
                            <table width="2000" id="product-table">
                            	<tr>
                                	<th class="trlegal ancho200">Accion</th>
                                	<th class="trlegal ancho150">Estado</th>
                                	<th class="trlegal ancho150">Turnado</th>
                                	<th class="trlegal ancho250">Asunto</th>
                                	<th class="trlegal ancho150">Remitente</th>
                                	<th class="trlegal ancho150">Cargo</th>
                                	<th class="trlegal ancho150">Dependencia</th>
                                	<th class="trlegal ancho100">Oficio</th>
                                	<th class="trlegal ancho100">Of. Fecha</th>
                                	<th class="trlegal ancho100">Of. Acuse</th>
                                	<th class="trlegal ancho100">CRAL</th>
                                	<th class="trlegal ancho100">C. Fecha</th>
                                	<th class="trlegal ancho100">C. Acuse</th>
                                	<th class="trlegal ancho100">DT</th>
                                	<th class="trlegal ancho100">Of. Conclución</th>
                                	<th class="trlegal ancho100">Of. Acuse</th>
                                </tr>
                            </table>
                        </div>
