...
function buscaAccion(limit)
{
	...
	//{
		...
		ajax=objetoAjax();
		ajax.open("post","procesosAjax/juicios_ajax_v2.php",true);
		ajax.onreadystatechange=function() 
		{
			if (ajax.readyState==4) 
			{
				...
				divtot.innerHTML = "<h3>"+accionesNum+" Actore(es) encontrado(s)</h3>";
...
$$(document).ready(function() {
	...
	$$.ajax
		({
			...
			type: "POST",
			url: "procesosAjax/juicios_ajax_v2.php",
			data: "",
			...
			{ 
				...
				divres.innerHTML = tablaHtml;
				divtot.innerHTML = "<h3>"+accionesNum+" Actor(es) encontrado(s)</h3>";
			}
		});
});
</script>
...
<!--  start product-table ..................................................................................... -->
<div   class="redonda10" style="padding:0px 15px;background: #ffcccc;">
...
<FORM onsubmit="return(false)" onkeypress="if(event.keyCode == 13) buscaAccion()">
    <h3>Buscar Autor, Juicio, Procedimiento o Acción: 
