...
if ($edoTram == 23 ) $sqledoT= " AND (detalle_edo_tramite = 23 OR detalle_edo_tramite = 24 OR detalle_edo_tramite = 25 OR detalle_edo_tramite = 26 OR detalle_edo_tramite = 45)";
...
if($presunto != "") 		$txtsql .= " INNER JOIN pfrr_presuntos_audiencias  on  pfrr.num_accion = pfrr_presuntos_audiencias.num_accion "; 
if($tipo_devolucion !="") 	$txtsql .= " INNER JOIN pfrr_historial on pfrr.num_accion = pfrr_historial.num_accion ";
//--------------------------------------------------------------------------------------------
//--------------------------------------------------------------------------------------------
//---------- DG vemos todo -----------------------------------------
if($direccion == 'DG')
	$txtsql .= " WHERE 1=1 $sqlvalor $sqledo $sqlsub $sqlef  $sqlaud $sqlemi_res  $sqljefe $sqlnoti_res $sqllim_not_res  $sqlcp $sqllim_emi_res  $sqlcie_ins $sqledoT $sqlult_act $sqlpo $sqlacu_inicio $sqlSicsa $sqlsuperveniente $sqlfecha $sqlpresunto $sqlfondo $sqluaa $sqldirector  $sqltipo_devolucion $sqlpdr $sqlpfrr";
//---------- SECRES ven direccion ----------------------------------
elseif($nivel == 'S')
	$txtsql .= " WHERE pfrr.subnivel LIKE '".$direccion."%'  $sqlvalor  $sqlemi_res $sqljefe $sqlnoti_res $sqllim_not_res $sqledo $sqllim_emi_res $sqlcie_ins $sqlsub $sqlult_act $sqlef  $sqlacu_inicio $sqlaud $sqlsuperveniente $sqlcp  $sqledoT $sqlpo $sqlSicsa $sqlfecha $sqlpresunto $sqlfondo $sqluaa $sqldirector  $sqltipo_devolucion $sqlpdr $sqlpfrr";
//---------- ABOGADOS segun nivel ----------------------------------
else 
	$txtsql .= " WHERE pfrr.subnivel LIKE '".$nivel."%'  $sqlvalor $sqledo   $sqlemi_res $sqljefe $sqlnoti_res $sqllim_not_res $sqlsub $sqllim_emi_res $sqlcie_ins $sqlef  $sqlaud $sqlacu_inicio $sqlcp $sqlsuperveniente $sqledoT $sqlpo $sqlSicsa $sqlfecha $sqlpresunto $sqlfondo $sqluaa $sqldirector  $sqltipo_devolucion $sqlpdr $sqlpfrr";
//--------------------------------------------------------------------------------------------
//--------------------------------------------------------------------------------------------
...
while($r = mysql_fetch_array($sqlT))
{
	...
	$tabla .= '
            <tr '.$estilo.' >';
				...
				<a href="#" title="Ver Bitacora" onclick=\'var cuadro1 = new mostrarCuadro2(500,1000,"'.$r['num_accion'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$r['entidad'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.dameEstado($r['detalle_edo_tramite']).'",50,"cont/pfrr_bitacora.php","numAccion='.$r['num_accion'].'&usuario='.$_SESSION['usuario'].'&direccion='.$_SESSION['direccion'].'")\' >
			...
			if($reports != 1)
			{
				...
				if($nivel != "S") $tabla .= '<a href="#" title="Modificar" class="icon-1 info-tooltip" onclick=\'var cuadrox1 = new mostrarCuadro(500,1200,"'.$r['pona'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$r['entidad'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.dameEstado($r['detalle_edo_tramite']).'",50,"cont/pfrr_proceso.php","numAccion='.$r['pona'].'&usuario='.$_SESSION['usuario'].'&direccion='.$_SESSION['direccion'].'")\'></a>';
				if($nivel != "S") $tabla .= '<a href="#" title="Presuntos" class="icon-6 info-tooltip" onclick=\'var cuadrox2 = new mostrarCuadro(550,1200,"'.$r['pona'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$r['entidad'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.dameEstado($r['detalle_edo_tramite']).'",30,"cont/pfrr_presuntos.php","numAccion='.$r['pona'].'&usuario='.$_SESSION['usuario'].'&direccion='.$_SESSION['direccion'].'")\'></a>';
				if($nivel != "S") $tabla .= '<a href="#" title="Autoridades" class="icon-7 info-tooltip" onclick=\'var cuadrox3 = new mostrarCuadro(500,1200," '.$r['num_accion'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$r['entidad'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.dameEstado($r['detalle_edo_tramite']).' ",50,"cont/pfrr_autoridades.php","numAccion='.$r['num_accion'].'&usuario='.$_SESSION['usuario'].'&direccion='.$_SESSION['direccion'].'")\'></a>';
			}
			$tabla .= '</td> </tr>';
}
	$tabla .= '
