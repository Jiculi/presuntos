...
<body>
	<div class="navbar">
		<a href="#" class="logo">Generar volantes (Amparo Indirecto)</a>
	...
	<div class="box_1">
        ...
        <form name="oficioForm" id="oficioForm" method="post" action="#">
            <table class="oficio-sin-redonda">
                    ...
                    <tr>
                        <td>Amparo Indirecto:</td>
                        <td>
                          <input type="text" name="numJuicio" id="numJuicio" value="<?php echo $ai; ?>" readonly>
                        </td>
						<td>
                    ...
                    <table class="tablaPasos tablaVol">         
                    	...
                    	<td>
                      	<select name="tipo" id="tipo" class="redonda5">
                      		...
                      		<option value="juicio">Amparo Indirecto</option>
                      	</select>
                    	</td>
                     	 </tr>
                    </table>
