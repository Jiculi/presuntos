...
<body>
	<div class="navbar">
		<a href="#" class="logo">Generar oficio (Amparo Indirecto)</a>
	...
	<div class="box_1" >
        ...
        <form name="formota" id="formota" method="post" action="#" class='formita'>
            <table class="oficio-sin-redonda">
                    <tr>
                        <td class="etiquetaOficio" > <p>Procedimiento</p></td>
                        <td>
                          	<input type="text" name="accionvolante" id="accionvolante" value="<?php echo $procedimiento; ?>"  readonly> 
                        </td>
					</tr>
					
                    <tr>
                        <td class="etiquetaOficio"> <p>Amparo Indirecto:</p></td>
                        <td>
                          	<input type="text" name="oficioRef" id="oficioRef"  value="<?php echo $ai; ?>" readonly>
                        </td>
						<td>
				...
				<table>
                    ...
                    <td>
                      <select name="tipo" id="tipo" class="oficio-redonda">
							...
							<option value="inf_just_ai">Informe Justificado en Amparo Indirecto</option>
							<option value="otros_of_ai">Otros Oficios en el Amparo Indirecto</option>
							<option value="inf_previo_ai">Informe Previo en Amparo Indirecto</option>
                      </select>
                    </td>
                  	</tr>
				</table>
