...
$numVolante = generaNumVolante($tipo, $fechaOficio, $horaOficio, $db->dameDirector($responsable), $userForm, $dirForm, $num_accion, $idJuicio);
...
$q->execute(array( $numVolante, $num_accion, $numJuicio, $idJuicio, $correoOficio, $correoFecha, $correoAcuse, $dependencia, 
                    $remitente, $cargo,  $asunto, $db->dameDirector($responsable), $tipo, $dirForm));
