...
<head>
	...
	<link rel="stylesheet" href="css/juiciosRecursoFiscal.css" >
</head>
...
<div id="ventana">
    <div id ="pageheader" class="navbar">
		<a href="#" class="logo">Alta de Recurso de Revisión Fiscal</a>
	...
	<div id="caja2">
        ...
        <form name="oficioForm" id="oficioForm"  class="formita" method="post" action="#">
            ...
            <label for="recurso">Número de Recurso:</label>
            <input type="text" name="recurso" id="recurso" >

			<label for="oficioRF">Número de Oficio:</label>
            <input type="text" name="oficioRF" id="oficioRF" >
...
<!--           <button id="botonRecurso" name="botonRecurso" > Alta de Recurso</button> -->
 			<input type="button" name="botonRecurso" id="botonRecurso" value="Dar de alta nuevo Recurso"> 
...
function comprobarFormulario() {
	...
	if( $('#recurso').val() == ''){
		...
		error++;
		mensaje = " - El número de recurso es obligatorio";
		document.getElementById("recurso").focus();	
	} else {
		document.getElementById('recurso').style.borderColor = 'silver';

		if( $('#oficioRF').val() == ''){
			document.getElementById('oficioRF').style.borderColor = 'red';
			error++;
			mensaje = "El número de Oficio es obligatorio";
			document.getElementById("oficioRF").focus();	
		} else {
			document.getElementById('oficioRF').style.borderColor = 'silver';
