...
<table width="100%">
    <tr>
        ...
        <tr>
                <form action="reportes/notificaciones.excel.php" method = "POST" >
                    <input type="hidden" name="export" value= <?php //echo urlencode($data) ?> />
                    <input type="hidden" name="nombre_archivo" value="Reporte Notificaciones"/>
                    <input type = "submit" class="submit_line" value = "Descargar en Excel" class="links">
				</form>

        <td>
        
        <iframe width="100%" height="400" frameborder="0" src="reportes/comportamientoDiarioPoObs2015.pdf.php"></iframe>
        </td>
