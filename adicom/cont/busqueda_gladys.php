...
function buscaAccionAvanzada(envio,limit)
{
	...
	Dirigido=document.getElementById('Destinatario').value;
	...
	OficioCh = document.getElementById('OficioCh').checked;
	volanteCh = document.getElementById('volanteCh').checked;
	uaaCh = document.getElementById('uaaCh').checked;
	DirigidoCh = document.getElementById('DirigidoCh').checked;
	AsuntoCh = document.getElementById('AsuntoCh').checked;
	...
	if(envio != "excel"){
		...
		ajax=objetoAjax();
		ajax.open("post","procesosAjax/ajax_busqueda_acciones_avanzada_gladys.php",true);
		...
		ajax.send("oficio="+oficio+"&volante="+volante+"&uaa="+uaa+"&dirigido="+dirigido+"&asunto="+asunto+"&oficioCh="+oficioCh+"&volanteCh="+volanteCh+"&uaaCh="+uaaCh+"&dirigidoCh="+dirigidoCh+"&asuntoCh="+asuntoCh);
	} else {
		//alert("Dme un excel");
		window.location.href = "procesosAjax/ajax_busqueda_excel_gladys.php?"+"oficio="+oficio+"&volante="+volante+"&uaa="+uaa+"&dirigido="+dirigido+"&asunto="+asunto+"&oficioCh="+oficioCh+"&volanteCh="+volanteCh+"&uaaCh="+uaaCh+"&dirigidoCh="+dirigidoCh+"&asuntoCh="+asuntoCh;
	}
	//-----------------funcion estados-------------//
            ...
            <table border="0" align="center" width="70%">
              <tr>
                ...
                <td><input type="text" name="noAccion2" id="pobus" class="redonda5" size=""/></td>
                 ...
                 <tr>       
                 <td class="etiquetaPo" >Dirigido a:</td>
                <td><input type="text" name="noAccion2" id="pobus" class="redonda5" size=""/></td>
                
                <tr>       
                 <td class="etiquetaPo" >Asunto:</td>
                <td><input type="text" name="noAccion2" id="pobus" class="redonda5" size=""/></td>
                ...
                <tr>
                  ...
                  <td colspan="3">
                    ...
                    <table width="100%" class="tds">
                      <tr>
                        <td><input type="checkbox" name="oficioCh" id="oficioCh" checked="checked"  /> Oficio</td>                           
                        </tr>
                      <tr>
                        <td><input type="checkbox" name="volanteCh" id="volanteCh" checked="checked"  /> Volante </td>
                        
                        <tr>
                        <td><input type="checkbox" name="dirigidoCh" id="dirigidoCh" checked="checked"  /> Dirigido </td>
                        
                        <tr>
                        <td><input type="checkbox" name="asuntoCh" id="asuntoCh" checked="checked"  /> Asunto </td>
                        </tr>
                      <tr>
