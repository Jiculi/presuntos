	...
	else  
	{
		...
		({
			...
			{ 
				...
				if(opcion == 'otros_PFRR' || opcion == 'sat_PFRR' || opcion == 'ef_PFRR' || opcion == 'icc_PFRR' || opcion == 'imss_PFRR' || opcion == 'issste_PFRR' || opcion == 'tribunal_pfrr' || opcion == 'comision_pfrr'|| opcion == 'pruebas_alcanceOT'|| opcion =='PFRR_citacion' || opcion=='solicitar_inf_tercero' || opcion=='enviar_info_ter' ||opcion=='continuacion_aud' ||opcion=='Not_Op_PR'||opcion =='not_acuerdo') 
				{
					$$("#cargo").attr("readonly",false); 
					$$("#remitente").attr("readonly",false);
					$$("#dependencia").attr('readonly',false);	 
