...
function asignarAccion()
{
	if(comprobarForm('asignaForm'))
	{
		...
		({
			...
			type: "POST",
			url: "procesosAjax/opiniones_asigna_accion.php",
        	...
        	<td width="50%">
            	...
            	<table  align="center" width="100%" border="0" class="tablaPasos tablaVol">
                  <tr>
                    ...
                    <td>
                      <input type="text" name="accionA" id="accionA" size="35" class="redonda5 camposEditar" value="<?php echo $accion ?>" readonly>
                    </td>
                  </tr>
                  </table> 
                  </div>
