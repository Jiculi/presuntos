...
$$(function() {
	  ...
	  //source: "procesosAjax/po_buscar_accion_otros_oficios.php?direccion= " /* este es el formulario que realiza la busqueda */
		   ...
		   {  
			...
			$$("#empgen").val(ui.item.da);
			$$("#cp").val(ui.item.cuepub);
			$$("#empdir").val(ui.item.actor);
			$$("#emppan").val(ui.item.monto);
			$$("#empniv").focus();
	...
	<form name= "empalta" id="empalta">
		...
		<table width="100%" align="center" class="feDif">
          ...
          <tr>
            ...
            <td><input type="text" class="redonda5 inputsSig" size="35" id="empnom" name="empnom"  value= "J.N.0<?php echo $juinext?>/2018" readonly="readonly"/>
          ...
          <tr>
            ...
            <td><input type = "text" name="empper" id="empper" size="35" class="redonda5 inputsSig"/></td>
          </tr>
           ...
           <tr>            
      		 <td class="etiquetaInfo redonda3">Entidad Fiscalizada</td>
 <td><input type="text" class="redonda5 inputsSig" size="35" font style="text-transform: uppercase "id="empcurp" name="empcurp" maxlength="100" readonly="readonly"/></td>
            ...
            <tr> 
            <td class="etiquetaInfo redonda3">Número de Acción</td>
            <td><input type="text" class="redonda5 inputsSig" size="35" id="emppas" name="emppas" readonly="readonly"/></td>
            ...
            <tr> 
            <td class="etiquetaInfo redonda3">Cuenta Pública</td>
            <td><input type="text" class="redonda5 inputsSig" size="35" id="cp" name="cp" readonly="readonly"/></td>
			...
			<td>
			<select name="empgen" id="empgen" class="redonda5 inputsSig" selected="selected"> <option value="" > ...</option>
<?php
...
?> 				
            ...
            <td>
			<select name="emppue" id="emppue" class="redonda5 inputsSig" readonly="readonly">
...
?> 
           ...
           <tr>
            ...
            <td><input type="text" class="redonda5 inputsSig" font style="text-transform: uppercase readonly="readonly" size="35" id="empdir" name="empdir" maxlength="100"/></td>
...
?> 
         ...
         <tr>
			...
			<input type="button" class="submit_line" name="alta_emp" id="alta_emp" value="Nuevo Juicio">
			</br>
			</td>
	    </tr>
		</table>
