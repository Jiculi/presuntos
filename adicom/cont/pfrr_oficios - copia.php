...
var accionesNum = 0;
//--------------------------------------
function agregarCampos(valor,estado,procedimiento,pdr,estadoTxt,mensaje)
{
	var igual = 0;
	 ...
	 $$("#accionvolante").autocomplete({
	  ...
	  select: function( event, ui ) {  
	   //reseteamos campos al seleccionar accion
		...
		agregarCampos(ui.item.value,ui.item.estado,ui.item.procedimiento,ui.item.pdr,ui.item.estadoTxt,ui.item.mensaje);
	  },
	...
	else  
	{
		...
		({
			...
			{ 
				...
				if(opcion == 'otros_PFRR' || opcion == 'sat_PFRR' || opcion == 'ef_PFRR' || opcion == 'icc_PFRR' || opcion == 'imss_PFRR' || opcion == 'issste_PFRR') 
				{
					$$("#cargo").attr("readonly",false); 
					$$("#remitente").attr("readonly",false);
					$$("#dependencia").attr('readonly',false);	 
                     ...
                     <tr>
                        ...
                        <td>
                          <select name="tipoOficio" id="tipoOficio" class="redonda5" onchange="verificaOpcion(this.value)" >
                            ...
                            <option class="opciones" value="tesofe_PFRR">TESOFE - Notificar PDR</option>
                            <option value="sat_PFRR">SAT - Solicitar Información</option>
                            <option value="ef_PFRR">Entidad Fiscalizada - Solicitar Información</option>
                            <option value="icc_PFRR">Contralorias - Solicitar Información</option>
                            <option value="imss_PFRR">IMSS - Solicitar Información</option>
                            <option value="issste_PFRR">ISSSTE - Solicitar Información</option>
