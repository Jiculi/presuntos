...
function insertaAccion(){
	if(comprobarForm('volanteForm')){
		...
		agregarCampos(estado,edoTxt,turnado,direccion,accion,ref,asunto,remitente,cargo,dependencia,oficio,ofiFec,ofiFecAcu,cral,cralFe,cralFecAcu,dt,ofConcluida,feConcluida)
...
function completaRemitentes(accion,tipo,seleccion)
{
	...
	{
		$$("#volTxt").html("Turnado: Dirección 'A' - 	 <br>Edo Trámite: Medios de Defensa  ");
...
$$(function() 
{
	...
	$$("#accionvolante").autocomplete({
	 ...
	 function( event, ui ) {  
		...
		if( validaAcciones(ui.item.turnado) && ui.item.edoModulo == "PFRR" ) {
			...
			if(ui.item.modulo != "PFRR") msj += " La acción esta en el módulo de "+ui.item.edoModulo+" debe ir al módulo Leaflets "+ui.item.edoModulo+" ";
			$$("#volTxt").html("");
			alert(msj)
...
<div id="pagVolantes" style="padding:10px 20px;background: #CEFF9D" class="redonda10">
    <!--
    ...
    <div id='p1' class=" redonda10 todosContPasos" >
        ...
        <tr>
            <td width="25%" valign="top">
                <div class="volanteDivCont redonda5"  style="height:200px;background: #CEFF9D ">
                 <table align="center" width="100%" border="0" class="tablaPasos tablaVol"> 
                  <tr>
                    ...
                    <td valign='top'>
                      ...
                      <input type="hidden"  class="redonda5 inputVolantes  inputsSig"  name="direccion" id="direccion" size="25" readonly>
                      <input type="hidden"  class="redonda5 inputVolantes  inputsSig"  name="turnado" id="turnado" size="25" readonly>
                      <input type="hidden"  class="redonda5 inputVolantes  inputsSig"  name="estado" id="estado" size="25" readonly>
                      <input type="hidden"  class="redonda5 inputVolantes  inputsSig"  name="edoTxt" id="edoTxt" size="25" readonly>
                      <input type="hidden"  class="redonda5 inputVolantes  inputsSig"  name="estadoPFRR" id="estadoPFRR" size="25" readonly>
                      <input type="hidden"  class="redonda5 inputVolantes  inputsSig"  name="prescripcion" id="prescripcion" size="25" readonly>
                      <input type="hidden"  class="redonda5 inputVolantes  inputsSig"  name="presuntos" id="presuntos" size="25" readonly>
                      <input type="hidden"  class="redonda5 inputVolantes  inputsSig"  name="montototal" id="montototal" size="25" readonly>
                   	</td>
                   </tr>
                   <!-- ----------------- -->
                   <tr>
                          ...
                          <select name="movimiento" id="movimiento" style="width:200px"  class="redonda5 inputVolantes  inputsSig " onchange="completaRemitentes($$('#accionVol').val(),'remitentesUAA',this.value)" >
                            ...
                            <optgroup class="grupo grupoPO" label="Pliego de Observaciones... " class="PO">
                             ...
                             <optgroup class="grupo grupoPFRR" label="Procedimiento Resarcitorio" class="PFRR">
                                ...
                                <option class="opciones PFRR" value="27" class="PFRR"> - Conclusión PFRR</option>
                                <option class="opciones PFRR" value="28" class="PFRR"> - Respuesta Técnica de la UAA</option>
                                <option class="grupoPFRR PFRR" value="SAT"> - SAT</option>
                                <option class="grupoPFRR PFRR" value="ef"> - Entidad Fiscalizada/Solicita Información</option>
                                <option class="grupoPFRR PFRR" value="atencion"> - Respuesta a un Oficio de DGR</option>
                                <option class="grupoPFRR PFRR" value="copiacono"> - Copia de Conocimiento</option>
				<option class="grupoPFRR PFRR" value="sol_dev"> - Solicitud de Devolución</option>                             </optgroup>
				<option class="grupoPFRR PFRR" value="env_inf"> - Envio de Información</option>                             </optgroup>
                             <!--
            ...
            <td  width="25%" >
            <div class="volanteDivCont redonda5"  style=" background:#CEFF9D">
            <table  align="center" width="100%" border="0" class="tablaPasos tablaVol">
              <tr>
          ...
          <td valign='top' width="25%" >
            ...
            <td  width="25%" >
                <div class="volanteDivCont redonda5" id="tablaCral"  style="height:100px;background:#CEFF9D">
                <table align="center" width="100%" border="0" class="tablaPasos tablaVol" >                        
                    <tr>
       ...
       <tr>
            ...
            <!-- -------------------------------------------------------------- -->
            	<div class="volDivAcci redonda5" id="contAcciones" style="height:330px; overflow:auto; background:#CEFF9D">
                    ...
                    <form name="todasAccionesVol" id="todasAccionesVol" enctype="application/x-www-form-urlencoded" method="post" >
                        <div>
                            <table width="2000" id="product-table">
                            	<tr>
                                	<th class="trpfrr ancho200">Accion</th>
                                	<th class="trpfrr ancho150">Estado</th>
                                	<th class="trpfrr ancho150">Turnado</th>
                                	<th class="trpfrr ancho250">Asunto</th>
                                	<th class="trpfrr ancho150">Remitente</th>
                                	<th class="trpfrr ancho150">Cargo</th>
                                	<th class="trpfrr ancho150">Dependencia</th>
                                	<th class="trpfrr ancho100">Oficio</th>
                                	<th class="trpfrr ancho100">Of. Fecha</th>
                                	<th class="trpfrr ancho100">Of. Acuse</th>
                                	<th class="trpfrr ancho100">CRAL</th>
                                	<th class="trpfrr ancho100">C. Fecha</th>
                                	<th class="trpfrr ancho100">C. Acuse</th>
                                	<th class="trpfrr ancho100">DT</th>
                                	<th class="trpfrr ancho100">Of. Conclución</th>
                                	<th class="trpfrr ancho100">Of. Acuse</th>
                                </tr>
                            </table>
                        </div>
