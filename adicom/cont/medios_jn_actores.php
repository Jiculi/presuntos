...
function buscaAccion()
{
	...
	//{
		...
		ajax=objetoAjax();
		ajax.open("post","procesosAjax/medios_jn_busqueda_actores.php",true);
...
$$(document).ready(function() {
	...
	$$.ajax
		({
			...
			type: "POST",
			url: "procesosAjax/medios_jn_busqueda_actores.php",
			data: "",
            ...
            <div class="encTabla">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="ancho150"><a href="#">Entidad Fiscalizada</a></th>
                        <th class="ancho50"><a href="#">Origen</a>	</th>
                        <th class="ancho100"><a href="#">Control Interno</a></th>
