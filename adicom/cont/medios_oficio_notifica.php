    ...
    <td width="50%">
      ...
      <td width="50%" rowspan="3" valign="top">
           ...
           <h3>Tipo <span id="accionesNo"></span> </h3>
            <?php 
			if($r['tipo'] == "sat_medios") echo "SAT - Medios de Defensa"; 
			if($r['tipo'] == "tribunal_medios") echo "Tribunal - Medios de Defensa"; 
			if($r['tipo'] == "actores_medios") echo "Actores - Medios de Defensa"; 
			if($r['tipo'] == "otros_medios") echo "Otros - Medios de Defensa"; 
