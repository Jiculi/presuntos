    ...
    <div id='resPasos' class='divPresuntos redonda10'>
        ...
        <div id="p1" class="todosContPasos pInactivo">
            ...
            while($r = mysql_fetch_array($sql))
            {
				...
				if($r['status'] == 0) $estilo="class='desa'" ; 
                ...
                $tablaExcel .= '
                        <tr '.$estilo.' style="vertical-align:middle">
                            <td style="border:1px dotted black;">'.$r['nombre'].'</td>
							<td style="border:1px dotted black;text-align:center">'.$r['responsabilidad'].'</td>
                            <td style="border:1px dotted black;">'.$r['cargo'].'</td>
							<td style="border:1px dotted black; text-align:justify">'. stripslashes($r['accion_omision']).'</td>
							<td style="border:1px dotted black;text-align:center">'.fechaNormal($r['prescripcion_accion_omision']).'</td>
                ...
                $tabla .= '
                        <tr '.$estilo.' >
                            <td class="" >'.$r['nombre'].' <br /> RESPONSABLE: '.$r['responsabilidad'].'</td>
                            <td class="" >'.$r['cargo'].'</td>
							<td class="" >'. stripslashes($r['accion_omision']).'</td>
							<td class="" >'.fechaNormal($r['prescripcion_accion_omision']).'</td>
				...
				$tabla .= '<a href="#" title="Montos" class="icon-11 info-tooltip" onclick=\'var cuadro5 = new mostrarCuadro2(600,800,"'.$r['nombre'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$r['num_accion'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.dameEstado($pfrr['detalle_edo_tramite']).'",10,"cont/pfrr_presuntos_montos.php","idPresuntop='.$r['cont'].'&numAccion='.$r['num_accion'].'&usuario='.$_REQUEST['usuario'].'&direccion='.$_REQUEST['direccion'].'")\'></a>';
				$tabla .= '<a href="#" title="'.$title2.'" class="icon-2 info-tooltip" onclick=\'var cuadro5 = new mostrarCuadro2(250,600,"'.$title2.'",10,"cont/pfrr_presunto_borra.php","idPresuntop='.$r['cont'].'&numAccion='.$r['num_accion'].'&usuario='.$_REQUEST['usuario'].'&direccion='.$_REQUEST['direccion'].'")\'></a>';
                $tabla .= '</td></tr>';
