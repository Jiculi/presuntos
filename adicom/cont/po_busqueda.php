...
<?php $ver = $_SESSION['direccion']; $ver1 = $_SESSION['nivel'];
if($ver == 'DG' || $ver1 == 'C' || $ver1 == 'A' || $ver1 == 'B' || $ver1 == 'D') {  $cons = ""; } else { $cons = "and direccion = '".$ver."' "; }
?>
        ...
        <center>
            <table border="0" align="center" width="70%">
              <tr>
                ...
                <td class="etiquetaPo" >Entidad Fiscalizada: <?php echo $ver; echo $cons; ?></td>
              ...
              <tr>
                ...
                <td>
                 ...
                 <option value="" selected="selected">Elegir</option>
                 <?php
                 $sql = $conexion->select("SELECT cp FROM po group by cp ORDER BY cp desc",false);
              ...
              <tr>
                ...
                <select name='fondo' id='fondo' class="redonda5" >
                   ...
                   <option value="" selected="selected">Elegir</option>
                 <?php
                 $sql = $conexion->select("SELECT fondo FROM po group by fondo ORDER BY fondo asc",false);
              ...
              <tr>
                ...
                <select name='uaa' id='uaa' class="redonda5" >
                    ...
                    <option value="" selected="selected">Elegir</option>
                 <?php
                 $sql = $conexion->select("SELECT uaa FROM po group by uaa ORDER BY uaa asc",false);
                 
                 while($ruaa = mysql_fetch_array($sql))
                    echo '<option value="'.$ruaa['uaa'].'">'.$ruaa['uaa'].'</option>';
