...
function buscaAccionAvanzadapr(envio,limit)
{
	if(envio != "excel"){
		$$("#conTabla2").slideUp();
	...
	if(envio != "excel"){
		...
		ajax=objetoAjax();
		ajax.open("post","procesosAjax/reporte_pr.php",true);
		...
		window.location.href = "procesosAjax/rep_pr_excel.php? "+"ef="+ef;
	}
...
<div id="content-table-inner">
  <link rel="stylesheet" href="css/estilo.css" type="text/css" media="screen" title="default" />
        ...
        <center>
            <table border="0" align="center" width="70%">
              <tr>
                ...
                <td class="etiquetaPo" >Presunto Responsable: </td>
              ...
              <table border="0" width="50%" align="center">
                <tr>
                  <td align="center">
                    ...
                    <input type="button" value="     Buscar      " name="Buscar" onclick="buscaAccionAvanzadapr()" class="submit-login" />
        </FORM>
    ...
    <div id="divDescarga" style="display:none;  padding:11px; float:right; margin:0 10px; width:230px" class="submit-login redonda5" >
    	<center> <span> <input type="button" value="Descargar en Excel" class="redonda5" onclick="buscaAccionAvanzadapr('excel')" /></span> </center>
    </div>
