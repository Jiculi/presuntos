...
<table width="100%">
    <tr>
         <form action="reportes/gladys.excel.php" method = "POST" >
                    <input type="hidden" name="export" value= <?php //echo urlencode($data) ?> />
                    <input type="hidden" name="nombre_archivo" value="Reporte Gladys"/>
                    <input type = "submit" class="submit_line" value = "Descargar en Excel" class="links">
				</form>    
    
        <td <?php if($_SESSION['direccion'] == "DG") echo 'width="60%"'; 
		else  echo 'width="100%"';  ?> >
        <iframe width="100%" height="400" frameborder="0" src="reportes/gladys.pdf.php"></iframe>
        </td>
