...
if(is_numeric($folio)) $sql = $conexion->select("SELECT * FROM oficios WHERE folio = '$folio' ",false);
else $sql = $conexion->select("SELECT * FROM oficios WHERE folio = '$folio' ",false);
...
<tr>
    <td width="50%">
        ...
        <tr>
            <td  class="etiquetaPo"><p>FOLIO:</p></td>
