	...
	else  
	{
		...
		({
			...
			{ 
				...
				if(opcion == 'otros_PFRR' || opcion == 'sat_PFRR' || opcion == 'ef_PFRR' || opcion == 'icc_PFRR' || opcion == 'imss_PFRR' || opcion == 'issste_PFRR' || opcion == 'tribunal_repo' || opcion=='comision' || opcion=='reiteracion') 
				{
					$$("#cargo").attr("readonly",false); 
					$$("#remitente").attr("readonly",false);
					$$("#dependencia").attr('readonly',false);	 
                     ...
                     <tr>
                        ...
                        <td>
                          <select name="tipoOficio" id="tipoOficio" class="redonda5" onchange="verificaOpcion(this.value)" >
                            ...
                            <option  value="resp_uaa">Iniciado. Responsabilidad UAA</option>
                            <option  value="reiteracion">Solicitud de Reiteración de inicio del PFRR a la UAA </option>
                            ...
                            <option value="tribunal_repo">TRIBUNAL - Reposición de Procedimiento</option>
