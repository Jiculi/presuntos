...
function buscaAccionAvanzada(envio,limit)
{
	...
	if(envio != "excel"){
		...
		ajax=objetoAjax();
		ajax.open("post","procesosAjax/ajax_busqueda_recurso_avanzada.php",true);
            ...
            <table border="0" align="center" width="70%" class= "feDif" >
              ...
              <tr>
                ...
                <td><select name='director' id='director' class="redonda5" >
                 ...
                 <?php
                 $sql = $conexion->select("SELECT * FROM usuarios WHERE LENGTH(nivel) = 1 AND puesto = 'Director de Área' ".$cons." ORDER BY nivel",false);
