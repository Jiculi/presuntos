    ...
    <td width="50%">
      ...
      <div class="volDivCont redonda5" id="camposAcciones">
           ...
           <h3>Tipo <span id="accionesNo"></span> </h3>
            <?php 
			if($r['tipo'] == "dtns_PFRR") echo "Devolución DTNS"; 
			if($r['tipo'] == "Not_icc_PFRR") echo "Notificación Inicio PFRR a la ICC"; 
			if($r['tipo'] == "citatorio_PFRR") echo "Oficio Citatorio"; 
			if($r['tipo'] == "opinion_UAA_PFRR") echo "Opinión Técnica de la UAA"; 
			if($r['tipo'] == "notificarRes_PFRR") echo "Notificar Resolución"; 
			if($r['tipo'] == "sat_PFRR") echo "SAT - Solicitar Información"; 
			if($r['tipo'] == "tesofe_PFRR") echo "SAT - Notificar PDR"; 
			if($r['tipo'] == "notificarResEF_PFRR") echo "Notificar Resolución a Entidad Fiscalizada"; 
			if($r['tipo'] == "ef_PFRR") echo "Entidad Fiscalizada - Solicitar Información"; 
			if($r['tipo'] == "icc_PFRR") echo "Contralorias - Solicitar Información"; 
			if($r['tipo'] == "imss_PFRR") echo "IMSS - Solicitar Información"; 
			if($r['tipo'] == "issste_PFRR") echo "ISSSTE - Solicitar Información"; 
			if($r['tipo'] == "otros_PFRR") echo "Otros Oficios"; 
    ...
    <tr>
        <td width="50%">
            <div class="volDivCont redonda5">
             <table align="center" width="100%" border="0" class="tablaPasos tablaVol">         
              <tr>
                <td class="etiquetaPo"> <p>Oficio Referencia:</p></td>
                <td>
