...
function buscaAccion(limit)
{
	...
	//{
		...
		ajax=objetoAjax();
		ajax.open("post","procesosAjax/juicios_ajax.php",true);
...
$$(document).ready(function() {
	...
	$$.ajax
		({
			...
			type: "POST",
			url: "procesosAjax/juicios_ajax.php",
			data: "",
			...
			{ 
				...
				divres.innerHTML = tablaHtml;
				divtot.innerHTML = "<h3>"+accionesNum+" Número De Juicio(s) Encontrado(s)</h3>";
			}
		});
});
</script>
