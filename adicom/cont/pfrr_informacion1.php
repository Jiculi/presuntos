...
<table align="center" class='tablaInfo' width="100%">
          ...
          <tr>
            ...
            <td><p class="txtInfo">
		<?php if ($r['superveniente'] != "") { 
					echo $r['superveniente'];
		} else { ?>
		
			<form name="formpres">
            	 <input class="redonda5" id="sicsa_clv" name="sicsa_clv" type="text" value='<?php echo $r['superveniente']; ?>' >
				 <input class="redonda5" id="sicsa_et" name="sicsa_et" type="hidden" value='<?php echo $r['detalle_edo_tramite']; ?>' >
				 <input class="redonda5" id="sicsa_usu" name="sicsa_usu" type="hidden" value='<?php echo $r['usuario']; ?>' >
                 <input class="submit_line" type="button" name="Registrar"  id="Registrar" value="Guardar" onclick="guardaclave()">
                 
                 <input type="hidden" name="num_accionsicsa" id="num_accionsicsa" value="<?php echo $accion; ?>">
            </form>
		
		<?php } ?>
			
			
			<?php ///echo $r['superveniente']; ?>
			</p> </td>
          ...
          <tr>
            ...
            <form name="fpress">
                 ...
                 <input class="submit_line" type="button" name="Registrar"  id="Registrar" value="Guardar" onclick="guardaPrescripcionPFRR()">
