...
function completaRemitentes(accion,tipo,seleccion)
{
	...
	if(seleccion == 2) 
		$$("#asunto").val('La UAA remite a esta DGR el PPO, de la acción en referencia, para su asesoría jurídica.');		
...
$$(function() 
{
	...
	$$("#accionvolante").autocomplete({
	 ...
	 function( event, ui ) {  
		...
		if( validaAcciones(ui.item.turnado) && ui.item.edoModulo == "PO" ) {
			...
			if(ui.item.modulo != "PO") msj += " La acción esta en el módulo de "+ui.item.edoModulo+" debe ir al módulo Leaflets "+ui.item.edoModulo+" ";
			$$("#volTxt").html("");
			alert(msj)
...
<div id="pagVolantes" style="padding:10px 20px;background:#A9D0F5" class="redonda10">
    <!--
                        ...
                        <input type="hidden" name="acccionPo" id="acccionPo" />
                          ...
                          <select name="movimiento" id="movimiento" style="width:200px"  class="redonda5 inputVolantes  inputsSig " onchange="completaRemitentes($$('#accionVol').val(),'remitentesUAA',this.value)" >
                            ...
                            <optgroup class="grupo grupoPO" label="Pliego de Observaciones... " class="PO">
                              ...
                              <option class="grupoPO PO" value="sol_informa" class="PO"> - Solicitud de información</option>
                              <option class="grupoPO PO" value="envio_informa" class="PO"> - Envio de información</option>
                              <option class="grupoPO PO" value="copia_conocimiento" class="PO"> - Copia de Conocimiento</option>
                             </optgroup>
                    ...
                    <form name="todasAccionesVol" id="todasAccionesVol" enctype="application/x-www-form-urlencoded" method="post" >
                        <div>
                            <table width="2000" id="product-table">
                            	<tr>
                                	<th class="trpo ancho200">Accion</th>
                                	<th class="trpo ancho150">Estado</th>
                                	<th class="trpo ancho150">Turnado</th>
                                	<th class="trpo ancho250">Asunto</th>
                                	<th class="trpo ancho150">Remitente</th>
                                	<th class="trpo ancho150">Cargo</th>
                                	<th class="trpo ancho150">Dependencia</th>
                                	<th class="trpo ancho100">Oficio</th>
                                	<th class="trpo ancho100">Of. Fecha</th>
                                	<th class="trpo ancho100">Of. Acuse</th>
                                	<th class="trpo ancho100">CRAL</th>
                                	<th class="trpo ancho100">C. Fecha</th>
                                	<th class="trpo ancho100">C. Acuse</th>
                                	<th class="trpo ancho100">DT</th>
                                	<th class="trpo ancho100">Of. Conclución</th>
                                	<th class="trpo ancho100">Of. Acuse</th>
                                </tr>
                            </table>
                        </div>
