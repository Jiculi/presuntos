...
<head>
    ...
    <title>Lista de Recursos de Revisión Fiscal</title>
   ...
   <script type="text/javascript" src="js/jquery-ui-1.12.1.custom/jquery-ui.min.js"></script> 
    ...
    <script type="text/javascript" src="e/juiciosRRFlista.js"></script>
...
<body>
    ...
    <div id="listajuicios">
        <div class="navbarJuicios">
            <a href="#" class="logo">Lista de Recursos de Revisión Fiscal</a>
